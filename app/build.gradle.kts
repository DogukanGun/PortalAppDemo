...
android {
    namespace = "com.dag.portaldemo"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.dag.portaldemo"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        buildConfigField("String","API_KEY","\"\"")
        buildConfigField("String","GOOGLE_DRIVE_KEY","\"\"")
        buildConfigField("String","SEPOLIA_ENDPOINT","\"\"")
...
dependencies {
    ...
    implementation("io.portalhq.android:portal-android:4.1.3")
